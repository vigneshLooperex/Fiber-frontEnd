...
const DashBoard = () => {
    ...
    const findDate = (date: any) => {
        ...
        const diffTime = Math.floor((lastDate.getTime() - today.getTime())/ (1000 * 60 * 60 * 24));
    ...
    const topData = [
        ...
        {
            name: 'Expired In',
            value:  findDate(user?.currentPlan.validity.to) || 'No Plan',
            image: expired,
        },
    ]
            ...
            <div className='home-dashboard'>
                ...
                <div className='dashboard-bill'>
                    <div className="dashboard-bill-header">
                        ...
                        <Button type='primary'><Link to='/bill'>View all</Link></Button>
                    </div>
                    <List
